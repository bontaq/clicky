...
* [`src/clicky/styles.cljs`](src/clicky/styles.cljs): CSS compilation source file (ClojureScript,
[Garden](https://github.com/noprompt/garden))
* [`src/clicky/`](src/clicky/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/clicky/core.cljs): contains the SPA entry point, `init`
...
5. Clone this repo and open a terminal in the `clicky` project root directory
...
The `debug?` variable in [`config.cljs`](src/cljs/clicky/config.cljs) defaults to `true` in
...
```clj
(ns clicky.example
  (:require [clicky.config :as config])
